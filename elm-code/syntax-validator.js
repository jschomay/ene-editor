...
{
	if (region.T.G === region.ab.G)
	{
		return 'on line ' + region.T.G;
	}
	return 'on lines ' + region.T.G + ' through ' + region.ab.G;
}
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {Z: col, as: problem, aA: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.aA, p.Z, p.as);
};
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{Z: 1, c: _List_Nil, d: 1, b: 0, aA: 1, a: src});
		if (!_n1.$) {
			var value = _n1.b;
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {Z: col, aR: contextStack, as: problem, aA: row};
	});
...
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4(elm$parser$Parser$Advanced$DeadEnd, s.aA, s.Z, x, s.c));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{Z: 1, c: s.c, d: s.d, b: s.b + 1, aA: s.aA + 1, a: s.a}) : A3(
				elm$parser$Parser$Advanced$Good,
				true,
				0,
				{Z: s.Z + 1, c: s.c, d: s.d, b: newOffset, aA: s.aA, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{Z: col, c: s0.c, d: s0.d, b: offset, aA: row, a: s0.a});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aA, s.Z, s);
	};
};
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.b, s.aA, s.Z, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{Z: newCol, c: s.c, d: s.d, b: newOffset, aA: newRow, a: s.a});
	};
};
...
var jschomay$elm_narrative_engine$NarrativeEngine$Core$WorldModel$addTag = F2(
	function (value, entity) {
		return _Utils_update(
			entity,
			{
				I: A2(elm$core$Set$insert, value, entity.I)
			});
	});
...
var jschomay$elm_narrative_engine$NarrativeEngine$Core$WorldModel$setLink = F3(
	function (key, value, entity) {
		return _Utils_update(
			entity,
			{
				x: A3(elm$core$Dict$insert, key, value, entity.x)
			});
	});
...
var jschomay$elm_narrative_engine$NarrativeEngine$Syntax$EntityParser$propsParser = function () {
	...
	var emptyNarrativeComponent = {x: jschomay$elm_narrative_engine$NarrativeEngine$Core$WorldModel$emptyLinks, m: jschomay$elm_narrative_engine$NarrativeEngine$Core$WorldModel$emptyStats, I: jschomay$elm_narrative_engine$NarrativeEngine$Core$WorldModel$emptyTags};
...
var jschomay$elm_narrative_engine$NarrativeEngine$Syntax$Helpers$deadEndsToString = function (deadEnds) {
	...
	var deadEndToString = function (deadend) {
		return problemToString(deadend.as) + (' at row ' + (elm$core$String$fromInt(deadend.aA) + (', col ' + elm$core$String$fromInt(deadend.Z))));
	};
...
var elm$parser$Parser$Advanced$chompUntil = function (_n0) {
	...
	var expecting = _n0.b;
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$findSubString, str, s.b, s.aA, s.Z, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var elm$parser$Parser$Advanced$keyword = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.aA, s.Z, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
...
var jschomay$elm_narrative_engine$NarrativeEngine$Syntax$RuleParser$ruleParser = function () {
	var toRule = F3(
		function (trigger, conditions, changes) {
			return {aQ: changes, _: conditions, aH: trigger};
		});
	...
	function (msg, model) {
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				...
				function () {
					var _n2 = A2(
						jschomay$elm_narrative_engine$NarrativeEngine$Syntax$EntityParser$parseEntity,
			...
			return _Utils_Tuple2(
				...
				function () {
					var _n4 = A2(
						jschomay$elm_narrative_engine$NarrativeEngine$Syntax$RuleParser$parseRule,
						elm$core$Basics$always(elm$core$Basics$identity),
						_Utils_Tuple2(
							string,
							{}));
